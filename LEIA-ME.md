...
Abra https://brunotrolo.github.io/ShopeeLabelPrinter/, arraste seu ZIP da Shopee e veja o preview. Funciona em: Chrome 80+, Edge 80+, Firefox 113+, Safari 16.4+.

### 💻 Versão Desktop (.exe)
1. Baixe o `ShopeeLabelPrinter.exe` mais recente em [Releases](https://github.com/brunotrolo/ShopeeLabelPrinter/releases)
...
### Versão Web
1. Abra https://brunotrolo.github.io/ShopeeLabelPrinter/
...
1. Acesse [Actions](https://github.com/brunotrolo/ShopeeLabelPrinter/actions)
...
Abra uma issue ou pull request no [GitHub](https://github.com/brunotrolo/ShopeeLabelPrinter).
